...
def test_only_bound_inputs_show_by_default():
    ...
    table = build_action_table(stub, stub.get_config(), "Default", lambda: None, {"expanded_rows": set()})
...
def test_expanded_row_state_survives_a_rebuild():
    ...
    table = build_action_table(stub, stub.get_config(), "Default", lambda: None, ui_state)
    ...
    rebuilt = build_action_table(stub, stub.get_config(), "Default", lambda: None, ui_state)
